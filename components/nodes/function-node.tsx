    ...
    >
      <CardHeader className="p-4 pb-2">
        <div className="flex items-center gap-2">
          <Function className="h-5 w-5 text-blue-600 dark:text-blue-400" />
      ...
      {data.instruction && (
        <CardContent className="p-4 pt-1 text-xs text-gray-700 dark:text-gray-300 font-medium leading-snug">
          {data.instruction}
        </CardContent>
      )}
